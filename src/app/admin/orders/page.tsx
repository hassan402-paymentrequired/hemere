        ...
        <main style={{ flex: 1, padding: '32px' }}>
          ...
          >
            {[
              ...
              <div
                key={s.label}
                style={{ background: '#ffffff', border: '1px solid #e8e8e1', padding: '20px 24px' }}
              >
                <p
                  style={{
                    fontFamily: 'Poppins, sans-serif',
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse' }}>
              <thead>
                <tr style={{ borderBottom: '1px solid #e8e8e1' }}>
                  {['Order', 'Customer', 'Date', 'Items', 'Payment', 'Amount', 'Status', ''].map(
                    (h) => (
                      <th
                        key={h}
                        style={{
            ...
            <div style={{ padding: '24px' }}>
              ...
              <div style={{ marginBottom: '24px' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                  {[
                    ...
                    {
                      label: 'Items',
                      value: `${selectedOrder.items} item${selectedOrder.items > 1 ? 's' : ''}`,
                    },
              ...
              <div style={{ marginBottom: '24px' }}>
                ...
                <div style={{ display: 'flex', flexWrap: 'wrap', gap: '8px' }}>
                  {(['Processing', 'Shipped', 'Delivered', 'Cancelled'] as Order['status'][]).map(
                    (s) => (
                      <button
                        key={s}
                        style={{
                          padding: '8px 14px',
                          border:
                            selectedOrder.status === s ? '1px solid #060606' : '1px solid #e8e8e1',
                          background: selectedOrder.status === s ? '#060606' : '#ffffff',
                          color: selectedOrder.status === s ? '#ffffff' : '#6b6b6b',
                          fontFamily: 'Poppins, sans-serif',
                          fontSize: '10px',
                          fontWeight: 300,
                          letterSpacing: '1px',
