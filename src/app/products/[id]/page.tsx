        ...
        <div style={{ maxWidth: '1500px', margin: '0 auto', padding: '48px 30px' }}>
          ...
          >
            ...
            <div style={{ position: 'sticky', top: '80px' }}>
              ...
              {/* Product details */}
              <div
                style={{ borderTop: '1px solid #f0f0ec', paddingTop: '24px', marginBottom: '24px' }}
              >
                <p
                  style={{
                    fontFamily: 'Poppins, sans-serif',
                  ...
                  >
                    <img
                      ...
                      style={{
                        ...
                        transform: hoveredRelated === rp.id ? 'scale(1.05)' : 'scale(1)',
                      }}
                    />
                    <div
                      style={{
                        ...
                        right: 0,
                        padding: '12px',
                        opacity: hoveredRelated === rp.id ? 1 : 0,
                        transform: hoveredRelated === rp.id ? 'translateY(0)' : 'translateY(8px)',
